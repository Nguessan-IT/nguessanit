...
export default function HomePage() {
  return (
    <div className="overflow-hidden">
      {/* Hero */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden" style={{ background: "linear-gradient(135deg, hsl(210 60% 97%) 0%, hsl(210 40% 98%) 30%, hsl(200 50% 96%) 60%, hsl(210 60% 95%) 100%)" }}>
        {/* Background effects */}
